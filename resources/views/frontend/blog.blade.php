<x-layouts.frontend
    ...
    <div class="section">
        <div class="hero-container">
            <div class="d-flex flex-column gspace-2 gspace-md-5">
                <!-- Blog Intro -->
                <div class="row row-cols-xl-2 row-cols-1 grid-spacer-5 gspace-1 m-0">
                ...
                <div class="row row-cols-md-2 row-cols-1 grid-spacer-3">
                    @foreach(collect(config('blog_posts')) as $post)
                    <div class="col">
                        <a href="{{ route('single-post', $post['slug']) }}">
                            <div class="card card-blog animate-box animated animate__animated" data-animate="animate__fadeInUp">
                                ...
                                <div class="card-body">
                                    ...
                                    <!-- Meta -->
                                    <div class="d-flex flex-row gspace-1 gspace-sm-2 flex-wrap">
